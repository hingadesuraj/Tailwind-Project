...
const Heor = () => {
  return (
    ...
    <div className='flex w-full  ' >
          {/* left */}
          <div className='  w-1/1.5 text-black-500' >
          ...
          {/* right */}
          <div className=' items-center justify-center w-full cover' >
            <img src="https://demo.themesberg.com/landwind/images/hero.png" width={500} alt="Hero Image" />
          </div>
    </div>
    </div>
  )
